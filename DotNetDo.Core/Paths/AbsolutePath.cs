...
public sealed partial record AbsolutePath
{
    ...
    /// <summary>Tries to normalize a Unix-rooted, drive-rooted, or UNC-rooted path without accessing the filesystem.</summary>
    /// <param name="path">The path text; may use either directory separator. <see langword="null"/>, relative, drive-relative, and NUL-containing paths are invalid.</param>
    /// <param name="result">The normalized absolute path when parsing succeeds; otherwise <see langword="null"/>.</param>
    ...
    /// <summary>Normalizes a Unix-rooted, drive-rooted, or UNC-rooted path without accessing the filesystem.</summary>
    /// <param name="path">The non-empty absolute path text; may use either directory separator. Relative, drive-relative, NUL-containing, and root-escaping paths are rejected.</param>
    ...
    /// <summary>Resolves a relative path against an absolute path, rejecting traversal above its root.</summary>
    /// <param name="left">The absolute base path.</param>
    /// <param name="right">The relative path to resolve.</param>
    ...
    /// <summary>Parses and resolves relative path text against an absolute path.</summary>
    /// <param name="left">The absolute base path.</param>
    ...
    /// <param name="directory">The candidate ancestor; paths on a different root are never considered ancestors.</param>
